                            ...
                            <div class="col-lg-9 ">
                                <div class="card " style=" left:15%;">
                                    <div class="card-body">
                                        ...
                                        <form class="needs-validation" action="add_articlee.php" method="POST"
                                                    ...
                                                    <div class="mb-3 position-relative">
                                                        ...
                                                        <div class="col-md-12">
                                                            <select class="form-select"
                                                                ...
                                                                <option value="nan" selected>--- Select a category ---
                                                                </option>
                                            ...
                                            <!-- End Col -->
                                                ...
                                                <input type="hidden" class="form-control" id="validationTooltip01"
                                                    placeholder="Entrez le titre de votre article... " required
                                                    name="id_user" value=<?php echo $_SESSION['user_id'];?>>
                                                <input type="hidden" class="form-control" id="validationTooltip01"
                                                    placeholder="Entrez le titre de votre article... " required
                                                    name="date">
                                                <?php
                                                 ...
                                                 if($userInfo->isAdmin == 'Yes') {
                                                    echo '
                                                        <input type="hidden" class="form-control" id="validationTooltip01"
                                                        placeholder="Entrez le titre de votre article... " required
                                                        name="isValidate" value="1">';
                                                 } else{
                                                    echo '
                                                    <input type="hidden" class="form-control" id="validationTooltip01"
                                                    placeholder="Entrez le titre de votre article... " required
                                                    name="isValidate" value="0">';
                                                 }
