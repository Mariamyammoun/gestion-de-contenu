                                        ...
                                        <?php
                                            foreach($c as $a)  {
                                                    echo "<tr>
                                                            ...
                                                            <td> <a href=" . "update_article.php/?id=" . $a->id. " class='btn edit' style='color:#007bff; '><i class='fa-solid fa-pen-to-square'></i></a>

                                                            <a  href=" . "delete_article.php/?id=" . $a->id . "  class='btn edit' style='color:#f16c69; '><i class='fa-solid fa-trash'></i></a></td>
                                                        </tr>";
                                            }
                                        ?>
                                    </tbody>
