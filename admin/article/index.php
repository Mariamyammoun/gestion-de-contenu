      ...
      <div id="flickity-hero" class="carousel-main">        
        ...
        <div class="carousel-cell hero__slide">
          <article class="hero__slide-entry entry">
            <div class="hero__slide-thumb-bg-holder" style="background-image: url(img/blog/hero_slider/featured_img_1.jpg)">
            ...
            <div class="hero__slide-thumb-text-holder">
              <div class="container">
                ...
                <h2 class="entry__title entry__title--white" style="font-size: 36px; margin-top: 10px; max-width: 700px;">
      ...
      <div class="row">
          ...
          <section class="section-dont-miss">
            ...
            <article class="entry post-list">
              ...
              <div class="entry__body post-list__body">
                ...
                <div class="entry__excerpt" style="   display: -webkit-box !important;
        ...
        <aside class="col-md-4 sidebar sidebar--right">
          ...
          <div class="widget widget-socials">
            ...
            <ul class="socials">
              <li>
                <a class="social-facebook" href="https://www.facebook.com/devosoftma" title="facebook" target="_blank">
                  <i class="ui-facebook"></i>
                  <span class="socials__text">Facebook</span>
                </a>
              </li>
              <li>
                <a class="social-linkedin" href="https://www.linkedin.com/company/devosoftma/?trk=public_profile_experience-item_profile-section-card_image-click&originalSubdomain=fr" title="linkedin" target="_blank">
                  <i class="ui-linkedin"></i>
                  <span class="socials__text">linkedin</span>
                </a>
              </li>
              <li>
                <a class="social-linkedin" href="https://www.linkedin.com/company/devosoftma/?trk=public_profile_experience-item_profile-section-card_image-click&originalSubdomain=fr" title="google" target="_blank">
                  <i class="ui-linkedin"></i>
                  <span class="socials__text">Linkedin</span>
                </a>
              </li>
              <li>
                <a class="social-instagram" href="https://www.instagram.com/devosoft_agency" title="instagram" target="_blank">
                  <i class="ui-instagram"></i>
