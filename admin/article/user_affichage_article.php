...
<body data-topbar="colored">
                                ...
                                <?php
                                        foreach($c as $a) {
                                            ...
                                            if ($a->isValidate == 1) {
                                                ...
                                                echo "<span class='badge rounded-pill bg-danger refuse-badge' data-toggle='modal'  title='Cliquez pour voir les remarques' data-id='" . $a->id . "'>Refusé</span>";
                                            }
                                            echo "</td>";
                                            echo "<td>" . $a->title . "</td>";
    ...
    <script>
        function setArticleId(articleId) {
            // Code pour envoyer l'ID à votre script PHP via AJAX
            console.log(articleId);
            var xhttp = new XMLHttpRequest();
            xhttp.open("GET", "?id_article=" + articleId, true); // Passer l'ID dans l'URL
            xhttp.send();
        }
    </script>
    <script>
