                                ...
                                <?php
                                            foreach($c as $a)  {
                                                    echo "<tr>
                                                            ...
                                                            <td><a href=" . "user_update.php/?id=" . $a->id. " class='btn edit'  style='color:#007bff; '><i class='fa-solid fa-pen-to-square'></i></a>
                                                            <a  href=" . "user_delete.php/?id=" . $a->id . "  class='btn edit' style='color:#f16c69; '><i class='fa-solid fa-trash'></i></a>
                                                            </td>
                                                        </tr>";
                                            }
                                        ?>
